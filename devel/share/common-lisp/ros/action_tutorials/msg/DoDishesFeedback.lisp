...
(cl:defmethod cl:initialize-instance :after ((m <DoDishesFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DoDishesFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name action_tutorials-msg:<DoDishesFeedback> is deprecated: use action_tutorials-msg:DoDishesFeedback instead.")))

(cl:ensure-generic-function 'percent_complete-val :lambda-list '(m))
(cl:defmethod percent_complete-val ((m <DoDishesFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader action_tutorials-msg:percent_complete-val is deprecated.  Use action_tutorials-msg:percent_complete instead.")
  (percent_complete m))
